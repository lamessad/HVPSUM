#' Jackknife Delete Values from LDSC for genetic covariance between trait 1 and 2
#' #'
#' This dataset contains the jackknife "delete values" derived from Linkage Disequilibrium Score Regression (LDSC).
#' These values represent the block-specific estimates genetic covariance obtained when a particular block is excluded from the analysis (i.e., leave-one-block-out).
#'
